    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('pos.order', $order->table_id)); ?>" class="btn btn-outline-secondary">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white py-3">
                    <h5 class="mb-0 fw-bold">Mesa: <?php echo e($order->table->name ?? 'Mesa'); ?> - Orden #<?php echo e($order->id); ?></h5>
                </div>
                
                <form action="<?php echo e(route('pos.split', $order->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-4">
                                            <input type="checkbox" name="selected_items[]" value="<?php echo e($detail->id); ?>" class="form-check-input item-check" data-price="<?php echo e($detail->price * $detail->quantity); ?>" onchange="calculateSplitTotal()">
                                        </td>
                                        <td>
                                            <div class="fw-bold"><?php echo e($detail->product->name); ?></div>
                                            <?php if($detail->note): ?> <small class="text-muted"><?php echo e($detail->note); ?></small> <?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-light text-dark border"><?php echo e($detail->quantity); ?></span>
                                        </td>
                                        <td class="text-end pe-4 fw-bold">
                                            <?php echo e(number_format($detail->price * $detail->quantity, 2)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\restaurante\resources\views/pos/partials/split_content.blade.php ENDPATH**/ ?>