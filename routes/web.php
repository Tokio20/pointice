...
Route::middleware(['auth'])->group(function () {
    ...
    // POS (Punto de Venta) - solo Admin, Cajero y Mozo
    Route::middleware(['role:admin,cashier,waiter'])->group(function() {
        ...
        // Herramientas de Orden (POS-related)
    ...
    // Monitor de Cocina - solo Admin y Cocina
    ...
    Route::middleware(['role:admin,cashier'])->group(function () {
        ...
        // Enviar boleta electrónica a SUNAT (scaffold)
        Route::post('/sunat/order/{order}/send', [\App\Http\Controllers\SunatController::class, 'send'])->name('sunat.send');
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::post('/settings/sunat/test', [SettingController::class, 'testSunat'])->name('settings.sunat.test');
