...
<head>
    ...
    <title><?php echo e(\App\Models\Setting::where('key', 'company_name')->value('value') ?? 'Mi Restaurante'); ?></title>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <?php $logo = \App\Models\Setting::where('key', 'company_logo')->value('value'); ?>
        <?php if($logo): ?> <img src="<?php echo e(asset('storage/'.$logo)); ?>" style="width: 40px; height: 40px; object-fit: cover; border-radius: 12px;">
        <?php else: ?> <div class="logo-box"><i class="bi bi-shop"></i></div> <?php endif; ?>
        <div class="brand-name ps-2 text-truncate"><?php echo e(\App\Models\Setting::where('key', 'company_name')->value('value') ?? 'Mi Restaurante'); ?></div>
    ...
    <div class="sidebar-menu">
        ...
        <?php if($role === 'admin'): ?>
            ...
            <a href="<?php echo e(route('system.index')); ?>" class="nav-link <?php echo e(request()->routeIs('system.*') ? 'active' : ''); ?> text-danger">
...
<div class="main-content">
    <?php if(!request()->routeIs('pos.order')): ?>
        <div class="top-navbar">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="fw-bold mb-0 text-dark d-none d-sm-block">
                    <?php if(request()->routeIs('dashboard')): ?> Panel de Control
                    <?php elseif(request()->routeIs('pos.*')): ?> Punto de Venta
                    <?php elseif(request()->routeIs('products.*')): ?> Inventario
                    <?php elseif(request()->routeIs('sales.*')): ?> Caja y Movimientos
                    <?php elseif(request()->routeIs('users.*')): ?> Gestión de Personal
                    <?php else: ?> Sistema de Restaurante <?php endif; ?>
                </h5>
            </div>
            ...
            <div class="dropdown">
                <div class="user-profile-btn" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="text-end d-none d-sm-block">
                        ...
                        <div class="text-muted" style="font-size: 0.7rem;"><?php echo e(ucfirst(Auth::user()->role)); ?></div>
                    </div>
    ...
    <?php if(session('error')): ?> 
        <div class="alert alert-danger border-0 shadow-sm rounded-4 mb-4 d-flex align-items-center bg-white border-start border-5 border-danger">
            ...
            <div><strong>Error:</strong> <?php echo e(session('error')); ?></div>
            <button type="button" class="btn-close ms-auto" data-bs-dismiss="alert"></button>
        </div> 
    <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body pt-2">
                ...
                <form action="<?php echo e(route('users.update', Auth::user()->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\restaurante\resources\views/layouts/app.blade.php ENDPATH**/ ?>